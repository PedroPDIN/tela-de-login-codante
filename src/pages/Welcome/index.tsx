  ...
  return (
    <section className="bg-[#070709] rounded-[34px] h-[480px] w-[800px]">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <button className="text-white font-normal text-[23px] leading-[30px] bg-gradient-to-tr from-[#4158D0] via-[#C850C0] to-[#FFCC70] w-[150px] h-[53px] rounded-2xl mt-6">Sair</button>
      </div>
    </section>
  );
}
