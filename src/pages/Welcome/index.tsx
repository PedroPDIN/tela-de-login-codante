...
function Welcome() {
  ...
  return (
    <section className="bg-[#070709] rounded-[34px] h-[480px] w-[800px] max-sm:w-[440px] sm:max-md:w-[470px]">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <BsFillCheckCircleFill className="text-[#070709] text-[100px] bg-gradient-to-t from-[#4158D0] via-[#C850C0] to-[#FFCC70] rounded-full w-[120px] animate-bounce my-10 max-sm:text-[70px] max-sm:w-[90px] sm:max-md:text-[80px] sm:max-md:w-[100px]" />
